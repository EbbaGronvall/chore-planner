"""
Django settings for chore_api project.
...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'chore_api.serializers.CurrentUserSerializer'
}
...
SECRET_KEY = 'django-insecure-%n@^ep)jw6go&uox*$ky9c8_k*h^s(zya+fvy!i=&4is7r)3uy'
